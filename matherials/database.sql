...
CREATE  TABLE IF NOT EXISTS `mydb`.`Employee` (
  ...
  `training` VARCHAR(200) CHARACTER SET 'utf8' NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `mydb`.`Event` (
  ...
  `name_event` VARCHAR(100) CHARACTER SET 'utf8' NOT NULL ,
  `id_category` INT NOT NULL ,
  `date_publication` DATE NOT NULL ,
  `hold_date` DATE NOT NULL ,
  `text_description` VARCHAR(1000) CHARACTER SET 'utf8' NULL DEFAULT NULL ,
  `url_pictures` VARCHAR(500) CHARACTER SET 'utf8' NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `mydb`.`Laboratory` (
  ...
  `description` VARCHAR(300) CHARACTER SET 'utf8' NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `mydb`.`NewsCategory` (
  ...
  UNIQUE INDEX `id_NewCategory_UNIQUE` (`id_newsCategory` ASC) ,
  INDEX () ,
  CONSTRAINT ``
    FOREIGN KEY ()
    REFERENCES `mydb`.`News` ()
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `mydb`.`News` (
  ...
  `date_publication` DATE NOT NULL ,
  `news_pictures` VARCHAR(200) CHARACTER SET 'utf8' NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `mydb`.`CourseApplication` (
  ...
  `decription` TEXT CHARACTER SET 'utf8' NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `mydb`.`Users` (
  ...
  `role` VARCHAR(100) CHARACTER SET 'utf8' NULL DEFAULT NULL ,
